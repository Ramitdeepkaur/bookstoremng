...
const EditBook = () => {
  ...
  const handleEditBook = () => {
    const data = { title, author, publishYear, copies } 
    setLoading(true)
      ...
      <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
        ...
        <div className='my-4'>
          ...
          <div className='flex items-center gap-2'>
            <button className='p-2 bg-gray-300' onClick={() => setCopies(Math.max(1, copies - 1))}>-</button>
            <input type='number' value={copies} onChange={(e) => setCopies(Number(e.target.value))} className='border-2 border-gray-500 px-4 py-2 w-full' min="1" />
